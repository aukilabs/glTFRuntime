...
{
	OpaqueMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/AukiUnrealSDK/glTF/M_glTFRuntimeBase"));
	OpaqueMaterial->AddToRoot();
	
	TranslucentMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/AukiUnrealSDK/glTF/M_glTFRuntimeTranslucent_Inst"));
	TranslucentMaterial->AddToRoot();

	TwoSidedMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/AukiUnrealSDK/glTF/M_glTFRuntimeTwoSided_Inst"));
	TwoSidedMaterial->AddToRoot();

	TwoSidedTranslucentMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/AukiUnrealSDK/glTF/M_glTFRuntimeTwoSidedTranslucent_Inst"));
	TwoSidedTranslucentMaterial->AddToRoot();

	SGOpaqueMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/AukiUnrealSDK/glTF/M_glTFRuntime_SG_Base"));
	SGOpaqueMaterial->AddToRoot();

	SGTranslucentMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/AukiUnrealSDK/glTF/M_glTFRuntime_SG_Translucent_Inst"));
	SGTranslucentMaterial->AddToRoot();

	SGTwoSidedMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/AukiUnrealSDK/glTF/M_glTFRuntime_SG_TwoSided_Inst"));
	SGTwoSidedMaterial->AddToRoot();

	SGTwoSidedTranslucentMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/AukiUnrealSDK/glTF/M_glTFRuntime_SG_TwoSidedTranslucent_Inst"));
...
int32 FglTFRuntimeParser::GetNumSkeletalAnimations() const
{
	const TArray<TSharedPtr<FJsonValue>>* JsonArray;
